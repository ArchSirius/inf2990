...
\subsubsection[{dessiner() const }]{\setlength{\rightskip}{0pt plus 5cm}void opengl\+::\+V\+B\+O\+::dessiner (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
...
Permet d\textquotesingle{}effectuer le dessin du modèle 3\+D. 
...
\subsubsection[{dessiner\+Selected() const }]{\setlength{\rightskip}{0pt plus 5cm}void opengl\+::\+V\+B\+O\+::dessiner\+Selected (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
...
\subsubsection[{V\+B\+O(modele\+::\+Modele3\+D const $\ast$modele)}]{\setlength{\rightskip}{0pt plus 5cm}opengl\+::\+V\+B\+O\+::\+V\+B\+O (
\begin{DoxyParamCaption}
...
Constructeur à partir d\textquotesingle{}un modèle 3\+D. 
...
Aucune. 
\end{DoxyReturn}
\hypertarget{group__modele_gafcea85cfc425d9c4720a32a53b720783}{}\index{Modele@{Modele}!````~V\+B\+O@{$\sim$\+V\+B\+O}}
\index{````~V\+B\+O@{$\sim$\+V\+B\+O}!Modele@{Modele}}
