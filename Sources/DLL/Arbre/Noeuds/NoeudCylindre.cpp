...
bool NoeudCylindre::clickHit(glm::ivec2 debut, glm::ivec2 fin)
{
	...
	return(positionRelative_.x + hitbox.rayon <= xMax && positionRelative_.x + hitbox.rayon >= xMin
		&& positionRelative_.x - hitbox.rayon <= xMax && positionRelative_.x - hitbox.rayon >= xMin
		&& positionRelative_.y + hitbox.rayon <= yMax && positionRelative_.y + hitbox.rayon >= yMin
		&& positionRelative_.y - hitbox.rayon <= yMax && positionRelative_.y - hitbox.rayon >= yMin);
}
