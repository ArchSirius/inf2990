...
///
////////////////////////////////////////////////////////////////////////
bool NoeudComposite::assignerSelectionEnfants(glm::dvec3 point, bool keepOthers, std::vector<GLubyte> color)
{
	for (auto& enfant : enfants_) {
        if (enfant->assignerSelectionEnfants(point, keepOthers, color)) {
